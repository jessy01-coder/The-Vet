...
import com.sanj.thevet.adapters.MyBookingsRecyclerViewAdapter;
...
import static com.sanj.thevet.data.URLs.fetchMyBookingsUrl;
...
public class MyBookedAppointments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_booked_appointments);
        mContext = this;
    ...
    private void loadData() {
        AlertDialog dialogWaiting = new Wrapper().waitingDialog("Fetching your bookings", mContext);
        Runnable loadDataThread = () -> {
            runOnUiThread(dialogWaiting::show);
            HashMap<String,String> params=new HashMap<>();
            params.put("nid",authenticatedNationalIdentificationNumber);

            StringRequest request = new StringRequest(Request.Method.POST, fetchMyBookingsUrl, response -> {
                try {
                    ...
                    if (responseCode.equals("1")){
                        ...
                        recyclerView.setAdapter(new MyBookingsRecyclerViewAdapter(appointmentModelList,mContext,this));
                    }else{
